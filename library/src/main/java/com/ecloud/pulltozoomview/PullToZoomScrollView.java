...
public class PullToZoomScrollView extends ScrollView {
    ...
    protected void onScrollChanged(int left, int top, int oldLeft, int oldTop) {
        ...
        if (isEnableZoom) {
            ...
            float ff = mZoomHeight - mZoomContainer.getBottom() + getScrollY();
            Log.i(TAG, "f = " + ff + ", mZoomHeight = " + mZoomHeight + ", mZoomContainer = " + mZoomContainer + " ,getScrollY() = " + getScrollY());

            Log.d(TAG, "onScrollChanged --> ");
            if (isParallax) {
                float f = mZoomHeight - mZoomContainer.getBottom() + getScrollY();
                Log.i(TAG, "f = " + f + ", mZoomHeight = " + mZoomHeight + ", mZoomContainer = " + mZoomContainer + " ,getScrollY() = " + getScrollY());
